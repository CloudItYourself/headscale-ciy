...
import (
	...
	"github.com/CloudItYourself/headscale-ciy"
	v1 "github.com/CloudItYourself/headscale-ciy/gen/go/headscale/v1"
	"github.com/CloudItYourself/headscale-ciy/hscontrol/db"
	"github.com/CloudItYourself/headscale-ciy/hscontrol/derp"
	derpServer "github.com/CloudItYourself/headscale-ciy/hscontrol/derp/server"
...
func (h *Headscale) getTLSSettings() (*tls.Config, error) {
	...
	if h.cfg.TLS.LetsEncrypt.Hostname != "" {
		...
		certReloader := types.CertReloader{
			CertFile:          h.cfg.TLS.CertPath,
			KeyFile:           h.cfg.TLS.KeyPath,
			CachedCert:        nil,
