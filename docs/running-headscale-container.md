...
3. **(Strongly Recommended)** Download a copy of the [example configuration](https://github.com/CloudItYourself/headscale-ciy/blob/main/config-example.yaml) from the headscale repository.
